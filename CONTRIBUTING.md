...
This document outlines the processes and practices recommended for contributing enhancements to `kubeflow-volumes`.
...
# Deploy the charm
juju deploy ./kubeflow-volumes_ubuntu-20.04-amd64.charm \
